  ...
  switch (action.type) {
    case types.INIT_PLE:
      newState = Object.assign({}, {
        base: _objectSpread(_objectSpread({}, defaults.setting.base), {}, {
        ...
        side: _objectSpread(_objectSpread({}, defaults.setting.side), action.preference.side),
        body: _objectSpread(_objectSpread({}, defaults.setting.body), action.preference.body)
      });
      return newState;
