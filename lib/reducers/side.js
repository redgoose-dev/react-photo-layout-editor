  ...
  switch (action.type) {
    case types.INIT_PLE:
      try {
        ...
        return _objectSpread(_objectSpread(_objectSpread({}, state), action.preference.side), {}, {
          files: _objectSpread(_objectSpread({}, state.files), files)
        });
      } catch (e) {
        return state;
      }
    ...
    case types.SIDE_ADD_FILES:
      ...
      return _objectSpread(_objectSpread({}, newState), {}, {
        files: _objectSpread(_objectSpread({}, newState.files), files)
      });
