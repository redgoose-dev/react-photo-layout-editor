...
function (_Component) {
  ...
  function ToggleSideButton() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ToggleSideButton).apply(this, arguments));
  }
  ...
  _createClass(ToggleSideButton, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("button", {
        ...
        className: (0, _classnames["default"])('ple-sp-ico', 'ple-abs', {
