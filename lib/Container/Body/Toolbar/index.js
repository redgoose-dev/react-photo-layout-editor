...
var Toolbar = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Toolbar, [{
    ...
    value: function changeActive(keyName, userSW, event) {
      ...
      this.setState({
        active: _objectSpread(_objectSpread({}, state.active), {}, _defineProperty({
          setting: false,
          editColor: false
        }, keyName, sw))
      });
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("nav", {
      ...
      }, state.visible.setting && /*#__PURE__*/_react["default"].createElement(_Button["default"], {
        ...
        onClick: function onClick(e) {
          ...
          if (!state.active.setting) {
            ...
            _this5.changeActive('setting', false, e);
          }
        },
        title: "Edit preference"
      }, state.active.setting && /*#__PURE__*/_react["default"].createElement(_EditLayoutSetting["default"], {
        submit: function submit(e) {
          return _this5.submitEditSetting(e);
        },
        setting: props.tree.body.setting,
        defaultSetting: props.setting.body.setting
      })), state.visible.shuffle && /*#__PURE__*/_react["default"].createElement(_Button["default"], {
        iconClass: "ple-ico-arrow-random",
        onClick: function onClick() {
          return props.api.grid.shuffle();
        },
        title: "Shuffle block"
      }), state.visible.add && /*#__PURE__*/_react["default"].createElement(_Button["default"], {
        iconClass: "ple-ico-plus",
        onClick: function onClick() {
          return props.api.grid.add();
        },
        title: "Add block"
      }), state.visible.select && /*#__PURE__*/_react["default"].createElement(_Button["default"], {
        iconClass: "ple-ico-select",
        onClick: function onClick() {
          return props.api.grid.toggleSelectAll();
        },
        title: "Toggle select block"
      }), state.visible.edit && /*#__PURE__*/_react["default"].createElement(_Button["default"], {
        ...
        title: "Edit block"
      }), state.visible.removeImage && /*#__PURE__*/_react["default"].createElement(_Button["default"], {
      ...
      }), state.visible.duplicate && /*#__PURE__*/_react["default"].createElement(_Button["default"], {
      ...
      }), state.visible.removeBlock && /*#__PURE__*/_react["default"].createElement(_Button["default"], {
        ...
        title: "Remove block"
      }), state.visible.editColor && /*#__PURE__*/_react["default"].createElement(_Button["default"], {
        ...
        onClick: function onClick(e) {
          ...
          if (!state.active.editColor) {
            ...
            _this5.changeActive('editColor', false, e);
          }
        },
        title: "Change color"
      }, /*#__PURE__*/_react["default"].createElement("div", {
